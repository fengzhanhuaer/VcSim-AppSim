...
/*=============================*/
	...
	{EN_DI_DO_SHTQ      ,   0,  "手合同期出口回采",            "DI_DO_SHTQ"},
...
const tagGoInTab  g_tGoInTab[] =
{
	...
	{EN_GOIN_SHTQ    ,      EN_CTYPE_IO_S,     CN_NULL_PINNO,  0,      "手合同期",     "GOIN_SHTQ" },
...
// 出口板1
	...
	{EN_DO_SHTQ,            EN_DTYPE_GOIN,  EN_GOIN_SHTQ      ,    CN_NULL_PINNO,  EN_DI_DO_SHTQ,        0,  "手合同期输出",        "DO_SHTQ"},
