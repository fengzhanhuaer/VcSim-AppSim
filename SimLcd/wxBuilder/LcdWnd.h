...
class SetLcdColour : public wxDialog
{
	...
	public:
		...
		SetLcdColour( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("设置颜色"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 305,182 ), long style = wxDEFAULT_DIALOG_STYLE );
...
class LogOnWnd : public wxDialog
{
	...
	public:
		...
		LogOnWnd( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("登录"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 473,246 ), long style = wxDEFAULT_DIALOG_STYLE );
